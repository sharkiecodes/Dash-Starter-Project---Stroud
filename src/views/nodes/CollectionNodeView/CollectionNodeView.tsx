...
interface CollectionNodeContentProps{
    store: NodeCollectionStore
}

@observer
export class CollectionNodeContent extends React.Component<CollectionNodeContentProps>{
    ...
    render() {
        ...
        return (
            ...
            >
               ...
               <CollectionNodeContent store = {store} />
